...
from src.mnist import dnn_inference
from src.mnist import dnn_train
    ...
    with tf.Graph().as_default() as g:
        ...
        with tf.Session() as sess:
            ...
            if ckpt and ckpt.model_checkpoint_path:
                ...
                print("After {} training steps, accuracy is {}", global_step, accuracy_score)
            else:
...
if __name__ == '__main__':
    print(dnn_inference.INPUT_NODE)
    tf.app.run()
